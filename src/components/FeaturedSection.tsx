      ...
      <div className="craft-container">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            نقدم لكم مجموعة متميزة من المنتجات الحرفية التي تجمع بين الأصالة والجمال
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              key={index}
              className="bg-background rounded-lg p-6 text-center craft-shadow"
            ...
            >
              <motion.div
                className="w-16 h-16 bg-craft-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 text-craft-primary"
